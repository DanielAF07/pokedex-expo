...
export class PokemonMapper {
  static fromPokeApiToEntity(data: PokeAPIPokemon): Pokemon {
    ...
    return {
      ...
      moves: data.moves.map(move => ({ name: move.move.name , level: move.version_group_details[0].level_learned_at }))
